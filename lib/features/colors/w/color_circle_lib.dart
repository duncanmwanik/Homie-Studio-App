...
class CircleColorPicker extends StatefulWidget {
  const CircleColorPicker({
    ...
    required MaterialColor initialColor,
  });
...
class CircleColorPickerState extends State<CircleColorPicker> with TickerProviderStateMixin {
          ...
          children: <Widget>[
            ...
            GestureDetector(
              onLongPress: () async {
                ...
                //   // commandWatch.addToFavorite('color', globalWatch.selected);
                // } else {
                //   showToast(2, 'Select a color from the circle!');
                // }
              },
